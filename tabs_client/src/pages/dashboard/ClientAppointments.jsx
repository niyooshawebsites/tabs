...
export default function DashboardClientAppointments() {
  ...
  const [fetchingClientAppointments, setFetchingClientAppointments] = useState(false);
  ...
  const fetchClientAppointments = async () => {
    try {
      ...
      if (data.success) {
        ...
        setFetchingClientAppointments(false);
      }
    } catch (err) {
      console.log(err);
                  ...
                  <DashboardHeading
                    title={
                      isDoctor == 'yes'
                        ...
                        : `Client ID: ${cid} - All Appointments (${
                            pagination.totalAppointments < 10 ? `0${pagination.totalAppointments}` : pagination.totalAppointments
                          })`
                    }
                  />
